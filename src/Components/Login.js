    ...
    <>
      ...
      >
        {({
          ...
          <div className="w-full p-6 m-auto bg-slate-300 rounded-md shadow-xl lg:max-w-xl">
              ...
              <form noValidate onSubmit={handleSubmit} className="mt-6">
                  <div className="mb-2">
                      ...
                      type="email"
                          ...
                          className=" form-control inp_text block w-full px-4 py-2 mt-2 text-purple-500 bg-white border rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                      />
                 ...
                 {errors.email && touched.email && errors.email}
                  ...
                  <div className="mb-2">
                      ...
                      <input
                          ...
                          type="password"
                          className="form-control block w-full px-4 py-2 mt-2 text-purple-700 bg-white border rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                      />
                       {/* If validation is not passed show errors */}
                <p className="error">
